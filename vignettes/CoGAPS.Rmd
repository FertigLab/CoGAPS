...
## Getting Information from CogapsResult

The `CogapsResult` object that's returned from `CoGAPS` has more than just
the raw matrices stored in it. Here are a few things you can query from the
result:
