...
```{r single cell}
# library(readr)
# pdac_peng_epi <- read.table("../data/pdac_peng_epi.csv", header=TRUE)
# pdac_path = "../data/pdac_peng_epi.csv"
# pdac_epithelial_result <- read_csv("../data/pdacresult.h5ad")
data <- readRDS("data/pdac_peng_epi.Rds")
library(CoGAPS)
...
text_result <- CoGAPS("../data/pdac_peng_epi.csv", pdac_params)
endTime <- Sys.time()
