...
b <- readRDS("inputdata_download.Rds")

https://github.com/FertigLab/CoGAPS/blob/master/data/inputdata.Rds
...
text_result <- CoGAPS(pdac_epi_counts, pdac_params)
endTime <- Sys.time()
...
# inputdata <- readRDS("~/fertiglab/manuscript_messing_around/CoGAPS/data/inputdata.Rds")

plotPatternUMAP(text_result, inputdata)
