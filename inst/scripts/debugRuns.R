...
# all sampler types
CoGAPS(GIST.matrix, sparseOptimization=FALSE, nIterations=1000)
CoGAPS(GIST.matrix, sparseOptimization=TRUE, nIterations=1000)
...
CoGAPS(GISTPathCsv, params, distributed="single-cell", transposeData=TRUE, nIterations=1000)
