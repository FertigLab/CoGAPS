...
cogapsTrans <- function(DFrame, SFrame, FixedPatt, ABinsFrame, PBinsFrame, Config, ConfigNums, time_of_sample, condition, theta, thin = 1L, prior = "normal", proposal = "normal", epsilon_mcmc = FALSE, delta = 10.0, epsilon = 100.0, epsilon_prior = 3.0, prior_mean = 0.0, prior_sd = 10.0) {
