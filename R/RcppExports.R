...
cogapsTrans <- function(DFrame, SFrame, ABinsFrame, PBinsFrame, Config, ConfigNums, time_of_sample, condition) {
    .Call('CoGAPS_cogapsTrans', PACKAGE = 'CoGAPS', DFrame, SFrame, ABinsFrame, PBinsFrame, Config, ConfigNums, time_of_sample, condition)
}
