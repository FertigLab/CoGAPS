...
#create a method to assign the value of parameter
setGeneric('setParam', function(params, whichParam, ...)
{
...
#create a method to get the value of the parameter
setGeneric('getParam', function(params)
{
